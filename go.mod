...
require (
	...
	kubevirt.io/api v1.3.0-beta.0.0.20240821172627-9d6ee0e9614a
...
replace (
	// v1.55+ uses securejoin.OpenInRoot/Reopen from filepath-securejoin v0.4.x,
	// which was removed in v0.6.x. opencontainers/selinux v1.13 requires v0.6.x,
	// so we pin containers/storage to v1.54.0 to avoid the conflict.
	github.com/containers/storage => github.com/containers/storage v1.54.0
	// docker/docker v28+ introduced breaking API changes (ImageLoad signature)
	// that containers/image v5.31.x is not compatible with.
