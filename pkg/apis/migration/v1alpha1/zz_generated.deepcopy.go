...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RunningPod) DeepCopyInto(out *RunningPod) {
	*out = *in
	if in.ObjectReference != nil {
		in, out := &in.ObjectReference, &out.ObjectReference
		*out = new(v1.ObjectReference)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RunningPod.
func (in *RunningPod) DeepCopy() *RunningPod {
	if in == nil {
		return nil
	}
	out := new(RunningPod)
