...
func (in *MigPlanStatus) DeepCopyInto(out *MigPlanStatus) {
	*out = *in
	in.Conditions.DeepCopyInto(&out.Conditions)
	if in.UnsupportedNamespaces != nil {
		in, out := &in.UnsupportedNamespaces, &out.UnsupportedNamespaces
		*out = make([]UnsupportedNamespace, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UnsupportedNamespace) DeepCopyInto(out *UnsupportedNamespace) {
	*out = *in
	if in.UnsupportedResources != nil {
		in, out := &in.UnsupportedResources, &out.UnsupportedResources
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UnsupportedNamespace.
func (in *UnsupportedNamespace) DeepCopy() *UnsupportedNamespace {
	if in == nil {
		return nil
	}
	out := new(UnsupportedNamespace)
	in.DeepCopyInto(out)
	return out
}
