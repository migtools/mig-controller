...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IncompatibleGVR) DeepCopyInto(out *IncompatibleGVR) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IncompatibleGVR.
func (in *IncompatibleGVR) DeepCopy() *IncompatibleGVR {
	if in == nil {
		return nil
	}
	out := new(IncompatibleGVR)
	in.DeepCopyInto(out)
	return out
}
...
func (in *IncompatibleNamespace) DeepCopyInto(out *IncompatibleNamespace) {
	*out = *in
	if in.GVRs != nil {
		in, out := &in.GVRs, &out.GVRs
		*out = make([]IncompatibleGVR, len(*in))
		copy(*out, *in)
	}
	return
}
