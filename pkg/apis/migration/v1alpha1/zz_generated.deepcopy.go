...
func (in *DirectVolumeMigrationStatus) DeepCopyInto(out *DirectVolumeMigrationStatus) {
	*out = *in
	...
	if in.UnknownPods != nil {
		in, out := &in.UnknownPods, &out.UnknownPods
		*out = make([]*PodProgress, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
	...
	if in.PendingSinceTimeLimitPods != nil {
		in, out := &in.PendingSinceTimeLimitPods, &out.PendingSinceTimeLimitPods
		*out = make([]*PodProgress, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
	...
	if in.SuccessfulLiveMigrations != nil {
		in, out := &in.SuccessfulLiveMigrations, &out.SuccessfulLiveMigrations
		*out = make([]*LiveMigrationProgress, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(LiveMigrationProgress)
				(*in).DeepCopyInto(*out)
			}
		}
	}
	if in.RunningLiveMigrations != nil {
		in, out := &in.RunningLiveMigrations, &out.RunningLiveMigrations
		*out = make([]*LiveMigrationProgress, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
	...
	if in.PendingLiveMigrations != nil {
		in, out := &in.PendingLiveMigrations, &out.PendingLiveMigrations
		*out = make([]*LiveMigrationProgress, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
	...
	if in.FailedLiveMigrations != nil {
		in, out := &in.FailedLiveMigrations, &out.FailedLiveMigrations
		*out = make([]*LiveMigrationProgress, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
	...
	if in.SkippedVolumes != nil {
		in, out := &in.SkippedVolumes, &out.SkippedVolumes
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LiveMigrationProgress) DeepCopyInto(out *LiveMigrationProgress) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LiveMigrationProgress.
func (in *LiveMigrationProgress) DeepCopy() *LiveMigrationProgress {
	if in == nil {
		return nil
	}
	out := new(LiveMigrationProgress)
...
func (in *StorageClass) DeepCopyInto(out *StorageClass) {
	*out = *in
	if in.VolumeAccessModes != nil {
		in, out := &in.VolumeAccessModes, &out.VolumeAccessModes
		*out = make([]VolumeModeAccessMode, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VolumeModeAccessMode) DeepCopyInto(out *VolumeModeAccessMode) {
	*out = *in
	if in.AccessModes != nil {
		in, out := &in.AccessModes, &out.AccessModes
		*out = make([]v1.PersistentVolumeAccessMode, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VolumeModeAccessMode.
func (in *VolumeModeAccessMode) DeepCopy() *VolumeModeAccessMode {
	if in == nil {
		return nil
	}
	out := new(VolumeModeAccessMode)
	in.DeepCopyInto(out)
	return out
}
