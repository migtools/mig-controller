...
// +kubebuilder:printcolumn:name="SrcCluster",type=string,JSONPath=`.spec.srcMigClusterRef.name`
// +kubebuilder:printcolumn:name="DestCluster",type=string,JSONPath=`.spec.destMigClusterRef.name`
// +kubebuilder:printcolumn:name="MigStorage",type=string,JSONPath=`.spec.migStorageRef.name`
type MigPlan struct {
