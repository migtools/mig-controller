...
type MigPlanSpec struct {
	...
	SrcMigTokenRef    *kapi.ObjectReference `json:"srcMigTokenRef,omitempty"`
	DestMigTokenRef   *kapi.ObjectReference `json:"destMigTokenRef,omitempty"`
...
func (r *MigPlan) GetSourceToken(client k8sclient.Client) (*MigToken, error) {
