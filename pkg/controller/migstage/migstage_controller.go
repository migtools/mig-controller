...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &migrationv1alpha1.MigStage{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create
	// Uncomment watch a Deployment created by MigStage - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &migrationv1alpha1.MigStage{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileMigStage) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &migrationv1alpha1.MigStage{}
