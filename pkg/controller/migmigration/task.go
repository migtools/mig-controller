...
var StageItinerary = Itinerary{
	...
	Phases: []Phase{
		...
		{Name: AnnotateResources, Step: StepStageBackup, any: HasStageBackup},
		...
		{Name: EnsureStageBackup, Step: StepStageBackup, any: HasStageBackup},
		{Name: StageBackupCreated, Step: StepStageBackup, any: HasStageBackup},
		{Name: EnsureStageBackupReplicated, Step: StepStageBackup, any: HasStageBackup},
		{Name: EnsureStageRestore, Step: StepStageRestore, any: HasStageBackup},
		{Name: StageRestoreCreated, Step: StepStageRestore, any: HasStageBackup},
		...
		{Name: EnsureAnnotationsDeleted, Step: StepCleanup, any: HasStageBackup},
