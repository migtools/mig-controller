...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &migrationsv1alpha1.MigrationPlan{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &migrationsv1alpha1.MigrationPlan{},
	})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=migrations.openshift.io,resources=migrationplans,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=migrations.openshift.io,resources=migrationplans/status,verbs=get;update;patch
func (r *ReconcileMigrationPlan) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the MigrationPlan instance
	instance := &migrationsv1alpha1.MigrationPlan{}
