...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &migrationsv1alpha1.Migration{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &migrationsv1alpha1.Migration{},
	})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=migrations.openshift.io,resources=migrations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=migrations.openshift.io,resources=migrations/status,verbs=get;update;patch
func (r *ReconcileMigration) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the Migration instance
	instance := &migrationsv1alpha1.Migration{}
