...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &migrationv1alpha1.MigPlan{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create
	// Uncomment watch a Deployment created by MigPlan - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &migrationv1alpha1.MigPlan{},
	})
	if err != nil {
		return err
	}
...
// Reconcile reads that state of the cluster for a MigPlan object and makes changes based on the state read
// and what is in the MigPlan.Spec
...
func (r *ReconcileMigPlan) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &migrationv1alpha1.MigPlan{}
